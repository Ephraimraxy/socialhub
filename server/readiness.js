...
export function getReadiness() {
  ...
  const checks = [
    ...
    check('claude', 'Claude API', appConfig.anthropicApiKey, 'Set ANTHROPIC_API_KEY.'),
    check('elevenlabs', 'ElevenLabs API', appConfig.elevenLabsApiKey, 'Set ELEVENLABS_API_KEY.'),
